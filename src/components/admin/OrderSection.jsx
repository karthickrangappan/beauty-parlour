...
export const InvoiceModal = ({ order: o, onClose }) => {
  ...
  return (
    <>
      <div
        className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-start justify-center overflow-y-auto py-10 px-4"
        onClick={onClose}
      >
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-3 bg-neutral-900 text-white">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={handlePrint}
                className="flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-400 transition-colors text-[10px] uppercase tracking-widest font-black text-white"
              >
          ...
          >
            ...
            <div className="flex justify-between items-start pb-8 border-b-2 border-neutral-900 mb-8">
              <div>
                <h1
                  className="text-4xl font-bold tracking-widest text-neutral-900 mb-1"
...
const OrderSection = ({ orders, orderSearch, setOrderSearch, updateOrderStatus, statusColors }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 border border-neutral-100 shadow-sm">
